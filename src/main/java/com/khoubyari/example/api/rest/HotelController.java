...
@RequestMapping(value = "/testapi",
    ...
    public
    @ResponseBody
    String testAPI( HttpServletRequest request, HttpServletResponse response,@RequestBody Map<String,String> commadMap) throws IOException, InterruptedException  {
