...
This is a sample Java / Maven / Spring Boot (version 1.5.5) application that can be used as a starter for creating a microservice complete with built-in health check, metrics and much more. I hope it helps you.
